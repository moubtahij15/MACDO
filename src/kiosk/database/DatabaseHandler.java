...
public class DatabaseHandler {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3306/SuperMarkets?user=root&password=";
//    String DB_URL = "jdbc:mysql://localhost:3306/mydatabase?user=myusername&password=mypassword";
